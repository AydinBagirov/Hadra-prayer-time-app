...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  String _getLocalizedMonth(int month) => _lang.t('month_$month');
  String _getLocalizedDay(int weekday) => _lang.t('day_$weekday');
      ...
      if (gpsLocation != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
                '${_lang.t('gps_set')}: ${_getCleanCityName(gpsLocation.name)}',
  ...
  String _adjustTime(String time, int minutesToAdd) {
    final cleanedTime = time.contains(' ')
        ? time.split(' ')[0].substring(0, 5)
        : time.substring(0, 5);
    final parts = cleanedTime.split(':');
    int totalMinutes =
        (int.parse(parts[0]) * 60) + int.parse(parts[1]) + minutesToAdd;
  ...
  void loadPrayerTimes() async {
    ...
    hesaplaKalanSure();
    service.fetch30DaysPrayerTimes(location).catchError((e) {
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(_lang.t('gps_loading'),
                style: const TextStyle(
                    fontFamily: 'MyFont2', color: Colors.white70)),
          ]),
        ),
      ),
    );
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(_lang.t('gps_error_body'),
                style: const TextStyle(
                    fontFamily: 'MyFont2', color: Colors.white60)),
            actions: [
              TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: Text(_lang.t('close'),
                      style: TextStyle(
                          fontFamily: 'MyFont2', color: theme.primary))),
            ],
          ),
        );
      }
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              _dialogOptionCard(
                ...
                isSelected:
                currentLocation?.name.startsWith('Xəritə:') ?? false,
                onTap: () async {
                  Navigator.of(context).pop();
    ...
    return AnimatedContainer(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(icon,
              color: isAktif ? theme.primary : Colors.white38, size: 20),
        ),
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    theme.surface,
                    theme.background,
                    Color.lerp(theme.background, theme.surface, 0.5)!
                  ],
                ),
              ),
            ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                    Border.all(color: theme.primary.withOpacity(0.18)),
                    boxShadow: [
                      BoxShadow(
                              ...
                              Expanded(
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(_getLocalizedDay(now.weekday),
                                          style: const TextStyle(
                                              fontFamily: 'MyFont2',
                                              fontSize: 11,
                                              color: Colors.white38)),
              ...
              loading
                ...
                child: FadeTransition(
                  ...
                  child: ListView(
                    ...
                    children: [
                      if (prayerTimes != null) ...[
                        _prayerRow(_lang.t('imsak'),
                            prayerTimes!.data.timings.imsak),
                        _prayerRow(_lang.t('sunrise'),
                            prayerTimes!.data.timings.sunrise),
                        _prayerRow(_lang.t('dhuhr'),
                            prayerTimes!.data.timings.dhuhr),
                        _prayerRow(_lang.t('asr'),
                            prayerTimes!.data.timings.asr),
                        _prayerRow(_lang.t('maghrib'),
                            prayerTimes!.data.timings.maghrib),
                        _prayerRow(_lang.t('isha'),
